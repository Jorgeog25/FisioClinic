    ...
    <div className="row">
      <div className="card">
        ...
        {loadingSlots ? (
          ...
          <div className="slots">
            {slots.length === 0 ? (
              <p>{msg || "No hay horas libres."}</p>
            ) : (
              slots.map((t) => (
                <button key={t} className="slot free" onClick={() => book(t)}>
                  {t}
                </button>
              ))
            )}
      ...
      <div className="card">
        ...
        {!myHistory ? (
          ...
          <>
            ...
            <p>
              <strong>
                {myHistory.client.firstName} {myHistory.client.lastName}
              </strong>{" "}
              · {myHistory.client.phone}
            </p>
